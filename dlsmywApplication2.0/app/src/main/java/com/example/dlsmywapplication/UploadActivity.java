...
public class UploadActivity extends AppCompatActivity {
  Button uped,nofinish,finish,back;
ListView menu;
int button=1;
...
UploadAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(activity_my__upload);
        if (getSupportActionBar() != null) {
            getSupportActionBar().hide();
        }
        uped = findViewById(R.id.uped);//使用记录按键
        nofinish = findViewById(R.id.nofinish);//待维修按键
        finish = findViewById(R.id.finish);//已维修按键
        ...
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(UploadActivity.this, UserActivity.class);
        ...
        function.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UploadActivity.this, BackupActivity.class);
                startActivity(intent);
            }
        });
        ...
        String url = "http:/10.242.146.175:8080/UserController/getUserRecordByUserid";
                ...
                if (response.isSuccessful()) {
                   ...
                   list.forEach(new Consumer<Map<String, Object> >() {
                       ...
                       public void accept(Map<String, Object>  map) {
                           msglist.add(new menumsg(map.get("equipment_name").toString(),map.get("equipment_position").toString(),map.get("used_time").toString(),map.get("equipment_id").toString()));
                       }
                   });
           ...
           //刷新
            public void onRefresh() {
                try {
                    ...
                    FormBody formBody = FbBuilder.build();
                    if(button==1)
                     url = "http://10.242.146.175:8080/UserController/getUserRecordByUserid";
                    else if(button==2)
        ...
        uped.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                button=1;
                DATA data = (DATA) getApplication();
...
menumsg m=msglist.get(i);
    Intent intent = new Intent(UploadActivity.this,  DetailNofinishActivity .class);
...
{
    menumsg m=msglist.get(i);
    Intent intent = new Intent(UploadActivity.this,  DetailFinishActivity .class);
    Bundle mBundle = new Bundle();
    mBundle.putString("eq_name",m.getMsg1());
    mBundle.putString("time",m.getMsg3());
    intent.putExtras(mBundle);
